...
class DashboardContextTest(TestCase):
	...
	def test_annual_activity_chart_uses_activity_table_monthly_average(self):
		...
		self.assertEqual(rows['Jan']['moyenne_plus_10'], 330000)
		self.assertEqual(rows['Jan']['moyenne_moins_10'], 270000)
		...
		self.assertEqual(rows['Fev']['moyenne_plus_10'], 770000)
		self.assertEqual(rows['Fev']['moyenne_moins_10'], 630000)
		...
		self.assertEqual(rows['Fev']['ecart_pct'], -14.3)
		self.assertEqual(rows['Fev']['ecart_label'], '-14.3%')
		...
		self.assertEqual(rows['Mar']['ecart_pct'], -6.2)
		...
		self.assertEqual(rows['Avr']['ecart_pct'], -4.2)
